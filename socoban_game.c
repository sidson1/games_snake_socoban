...
void updatePlayer()
{
	...
	else if (map[y + dy][x + dx] == 'H' && (map[y + 2 * dy][x + 2 * dx] == ' ' || map[y + 2 * dy][x + 2 * dx] == 'x'))
	{
		x += dx;
		y += dy;
	...
	for (int i = 0; i < numberBoxes; i++)
	{
		...
		if (isFin == false)
			if (map[boxes[i][1] + STEP][boxes[i][0]] == '#' && map[boxes[i][1]][boxes[i][0] + STEP] == '#' ||
				map[boxes[i][1] + STEP][boxes[i][0]] == 'H' && map[boxes[i][1]][boxes[i][0] + STEP] == '#' ||
				map[boxes[i][1] + STEP][boxes[i][0]] == '#' && map[boxes[i][1]][boxes[i][0] + STEP] == 'H' ||
